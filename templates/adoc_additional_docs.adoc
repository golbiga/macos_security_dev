...
|Document Number or Descriptor
|Document Title 
|link:https://csrc.nist.gov/publications/detail/sp/800-66/rev-2/draft[NIST Special Publication 800-66 Rev 2 Draft 2]|_An Introductory Resource Guide for Implementing the Health Insurance Portability and Accountability Act (HIPAA) Security Rule_
|link:https://405d.hhs.gov/protect[HHS 405(d) Aligning Health Care Industry Security Approaches]|_HHS 405(d) Aligning Health Care Industry Security Approaches_
|===
